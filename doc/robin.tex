...
\abstract{
The ROBIN body is a VTOL fuselage shape originally introduced in ?? which is defined
by the intersection of two sets of quadratic surfaces.
While the shape is used frequently in research, the coefficients, where published,
do not reliably produce the geometry. This letter serves as a notice of the 
correct coefficients and a public repository for their distribution.
}
